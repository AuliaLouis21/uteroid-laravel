<div id="content">
    ...
    <div id="rightcolumn2">
    	...
    	<span class="titleform">ADD NEW VIDEO</span>
        <form method="post" class="cssformright" enctype="multipart/form-data">      
			...
			<p>
            	<label for="vid">URL YOUTUBE</label>
            	<input type="text" name="vid" id="vid" value="<?=(isset($error))?$_POST['nama']:NULL;?>"/>
            </p>     
            
            <p>
            	<label>&nbsp;</label>
                <input type="submit" name="submit" value="add video"  style="text-transform:uppercase; font-size:14px;"/>
            </p>            
        </form>
    </div>
</div>